...
class PlottingService():
    ...
    def get_gender_pie_figure(self):
...
figure1 = PlottingService().get_age_hist_figure();
figure2 = PlottingService().get_gender_pie_figure();
figure3 = PlottingService().get_marital_status_barplot();

PlottingService.plot_figures([[figure1, figure2, figure3], [None, None]]);
